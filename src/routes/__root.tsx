...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PoolCheck — בדיקת מים לבריכה" },
      { name: "description", content: "צלם סטיק בדיקה וקבל המלצה כמה חומר להוסיף לבריכה" },
      { property: "og:title", content: "PoolCheck — בדיקת מים לבריכה" },
      { property: "og:description", content: "צלם סטיק בדיקה וקבל המלצה כמה חומר להוסיף לבריכה" },
