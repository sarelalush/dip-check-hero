...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "התחברות — AquaSense" }] }),
    ...
    <div dir="rtl" className="min-h-screen bg-gradient-to-b from-cyan-50 via-white to-white">
      <div className="mx-auto max-w-md px-6 pb-10 pt-8">
        ...
        <div className="mt-8 text-right">
          <h1 className="text-3xl font-extrabold text-foreground">ברוכים השבים</h1>
          <p className="mt-2 text-sm text-muted-foreground">היכנסו כדי להמשיך לעקוב אחרי הבריכה שלכם.</p>
        </div>
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          ...
          <Field label="סיסמה" icon={<Lock className="h-4 w-4" />}>
            <input
