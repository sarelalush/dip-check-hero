...
const styles = StyleSheet.create({
  ...
  formCardCompact: { marginTop: 10, borderRadius: 20, paddingHorizontal: 15, paddingTop: 13, paddingBottom: 12, gap: Platform.OS === 'android' ? 0 : 8 },
  fieldWrap: { gap: 8 },
  fieldRow: { flexDirection: 'row-reverse', gap: 8 },
  fieldWrapCompact: { gap: 5, ...(Platform.OS === 'android' ? { marginBottom: 7 } : null) },
  ...
  primaryButtonCompact: { minHeight: 42, borderRadius: 12, ...(Platform.OS === 'android' ? { marginTop: 3, marginBottom: 6 } : null) },
  ...
  dividerRowCompact: { gap: 10, marginVertical: Platform.OS === 'android' ? 6 : 1 },
  ...
  socialButtonCompact: { minHeight: 39, borderRadius: 11, paddingHorizontal: 15, ...(Platform.OS === 'android' ? { marginTop: 5 } : null) },
  ...
  secureRowCompact: { marginTop: Platform.OS === 'android' ? 8 : 2, gap: 4 },
