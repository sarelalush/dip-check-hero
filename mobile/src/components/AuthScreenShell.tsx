...
const styles = StyleSheet.create({
  ...
  formCardCompact: { marginTop: 8, borderRadius: 20, paddingHorizontal: 15, paddingTop: 10, paddingBottom: 8, gap: 5 },
  fieldWrap: { gap: 8 },
  fieldRow: { flexDirection: 'row-reverse', gap: 8 },
  fieldWrapCompact: { gap: 3 },
  ...
  inputShellCompact: { minHeight: 35, borderRadius: 11, paddingHorizontal: 10, gap: 5 },
  ...
  primaryButtonCompact: { minHeight: 38, borderRadius: 12 },
  ...
  dividerRowCompact: { gap: 9, marginVertical: -2 },
  ...
  socialButtonCompact: { minHeight: 35, borderRadius: 11, paddingHorizontal: 15 },
