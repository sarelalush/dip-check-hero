...
function ScanFrame({ compact, phone }: { compact: boolean; phone?: boolean }) {
  return (
    <View style={[styles.scanFrame, compact && styles.scanFrameCompact, phone && styles.phoneFrame, compact && phone && styles.phoneFrameCompact]}>
...
const styles = StyleSheet.create({
  ...
  scrollContentCompact: { minHeight: '100%', paddingTop: 6 },
  scrollContentVeryCompact: { minHeight: '100%', paddingTop: 4 },
  ...
  brandRowCompact: { marginBottom: 7 },
  brandDip: {
    color: NAVY,
  ...
  dropLogoCompact: { borderBottomLeftRadius: 24, borderBottomRightRadius: 24, borderRadius: 24, borderWidth: 3, height: 40, marginLeft: 8, width: 34 },
  progressPill: {
  ...
  progressPillCompact: { marginBottom: 5, paddingHorizontal: 15, paddingVertical: 4 },
  progressText: {
    color: NAVY,
  ...
  scanFrameCompact: { borderRadius: 24, height: 126, width: 170 },
  phoneFrame: { backgroundColor: 'rgba(255,255,255,0.16)', borderColor: colors.white, borderWidth: 9, height: 220, width: 178 },
  phoneFrameCompact: { borderRadius: 24, borderWidth: 7, height: 154, width: 126 },
  ...
  stripHolderCompact: { height: 142, width: 54 },
  strip: {
    alignItems: 'center',
  ...
  stripCompact: { borderRadius: 10, height: 134, paddingVertical: 9, width: 30 },
  pad: { borderColor: 'rgba(255,255,255,0.65)', borderRadius: 5, borderWidth: 1, height: 25, width: 25 },
  padCompact: { height: 14, width: 14 },
  ...
  resultRowCompact: { gap: 5, marginBottom: 4, paddingHorizontal: 7, paddingVertical: 4 },
  ...
  recommendCardCompact: { borderRadius: 18, borderWidth: 5, marginTop: 3, padding: 8, width: 226 },
  ...
  volumeBoxCompact: { marginBottom: 5, padding: 8 },
  ...
  recommendRowCompact: { gap: 5, marginTop: 3, padding: 6 },
  ...
  planHeroCompact: { gap: 12, height: 118, width: 226 },
  ...
  bigDropCompact: { borderRadius: 36, height: 72, width: 60 },
  ...
  shieldHeroCompact: { height: 64, width: 54 },
  instructionCard: {
  ...
  instructionCardCompact: { borderTopLeftRadius: 32, borderTopRightRadius: 32, minHeight: 0, paddingBottom: 9, paddingHorizontal: 22, paddingTop: 31 },
  instructionCardLastCompact: { paddingTop: 28 },
  ...
  addonsRow: { flexDirection: 'row-reverse', gap: 6, marginTop: 5 },
  addon: { backgroundColor: '#F5FCFD', borderColor: 'rgba(9,175,200,0.18)', borderRadius: 12, borderWidth: 1, flex: 1, padding: 5 },
  ...
  primaryButtonCompact: { borderRadius: 16, minHeight: 43 },
  primaryLabel: { color: colors.white, fontFamily: typography.fontFamilyExtraBold, fontSize: 28, fontWeight: '800', ...rtl.textCenter },
  primaryLabelCompact: { fontSize: 20 },
  dots: { alignItems: 'center', flexDirection: 'row-reverse', gap: 10, justifyContent: 'center', marginTop: 6 },
  dot: { backgroundColor: INACTIVE_DOT, borderRadius: 5, height: 10, width: 10 },
  dotActive: { backgroundColor: TURQUOISE },
  skipButton: { alignSelf: 'center', marginTop: 2, paddingHorizontal: 20, paddingVertical: 0 },
  skipText: { color: colors.primaryDark, fontFamily: typography.fontFamilyBold, fontSize: 18, fontWeight: '700', ...rtl.textCenter },
  skipTextCompact: { fontSize: 15 },
